...
<header class="header-container">
    ...
    <nav class="header-element">
        <ul>
            ...
            <?php } ?>
            <?php if (isset($_SESSION['user_id'])) { ?>
                <li><a href="index.php?controller=User&action=ShowProfilRP"><i class="fa-solid fa-user fa-xl" style="color: #ffffff;"></i></a></li>
                <li><a href="index.php?controller=Auth&action=logout"><i class="fa-solid fa-right-from-bracket fa-xl" style="color: #ffffff;"></i></a></li>
            <?php } else { ?>
